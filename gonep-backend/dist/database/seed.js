...
async function seedDatabase() {
    try {
        ...
        const adminPasswordHash = await bcryptjs_1.default.hash('password123', 12);
        try {
        ...
        const categories = await database_1.db.insert(schema_1.blogCategories).values([
            {
                name: 'Technology',
                slug: 'technology',
        ...
        const authors = await database_1.db.insert(schema_1.blogAuthors).values([
            {
        ...
        const posts = await database_1.db.insert(schema_1.blogPosts).values([
            {
        ...
        const teamMembersData = await database_1.db.insert(schema_1.teamMembers).values([
            {
        ...
        const values = await database_1.db.insert(schema_1.teamValues).values([
            {
        ...
        const depts = await database_1.db.insert(schema_1.departments).values([
            {
                name: 'Engineering',
        ...
        const jobs = await database_1.db.insert(schema_1.jobOpenings).values([
            {
        ...
        const partnersData = await database_1.db.insert(schema_1.partners).values([
            {
        ...
        const contactMethodsData = await database_1.db.insert(schema_1.contactMethods).values([
            {
                type: 'Phone',
                title: 'Call Us',
        ...
        const stats = await database_1.db.insert(schema_1.impactStatistics).values([
            {
                number: '10,000+',
        ...
        const faqsData = await database_1.db.insert(schema_1.faqs).values([
            {
                category: 'General',
        ...
        const supportResourcesData = await database_1.db.insert(schema_1.supportResources).values([
            {
                title: 'User Manual',
        ...
        const features = await database_1.db.insert(schema_1.productFeatures).values([
            {
        ...
        const specs = await database_1.db.insert(schema_1.technicalSpecs).values([
            {
        ...
        const useCasesData = await database_1.db.insert(schema_1.useCases).values([
            {
        ...
        const media = await database_1.db.insert(schema_1.mediaResources).values([
            {
                type: 'whitepaper',
        ...
        const press = await database_1.db.insert(schema_1.pressCoverage).values([
            {
