...
export const JOB_APPLICATION_STATUSES: JobApplicationStatus[] = ['pending', 'reviewed', 'shortlisted', 'rejected', 'hired'];
export const DEMO_REQUEST_STATUSES: DemoRequestStatus[] = ['pending', 'scheduled', 'completed', 'cancelled'];
export const CONTACT_INQUIRY_STATUSES: ContactInquiryStatus[] = ['new', 'in_progress', 'resolved', 'closed'];
